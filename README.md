...
| Perfil | Acesso |
|---|---|
| Gestora de Atendimento | Completo — agenda, clientes, financeiro, relatórios |
| Sócia / Enfermeira | Restrito — agenda e dados do atendimento |
...
- [ ] Cadastro de clientes com histórico (P1)
- [ ] Registro de atendimentos (P1)
- [ ] Relatório financeiro mensal (P2)
- [ ] Controle de disponibilidade das sócias (P2)
...
│   └── 002-requisitos.md          # Artefato QA #002 — Documento de requisitos
│
...
| # | Artefato | Status |
|---|---|---|
| 001 | Roteiro de Entrevista com Cliente | ✅ Concluído |
| 002 | Documento de Requisitos | ✅ Concluído |
| 003 | Casos de Teste | 🔄 Em elaboração |
| 004 | Plano de Testes | ⏳ Pendente |
| 005 | Relatório de Bugs | ⏳ Pendente |

---

## 🔍 Critérios de Aceite Principais

1. As 3 sócias conseguem visualizar e editar a agenda simultaneamente pelo celular, sem conflito
2. A gestora sabe em qualquer momento quais clientes têm pagamento em aberto
3. Cadastro de novo atendimento realizado em menos de 1 minuto pelo celular
4. Faturamento mensal calculado automaticamente, sem soma manual
5. Sócias acessam apenas agenda e dados do atendimento — sem acesso ao financeiro
